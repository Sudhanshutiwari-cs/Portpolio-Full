    ...
    <StyledWrapper>
      <div className="card">
        ...
        <div className="card-title-area">
          <span>ConvoSphere</span>
          <span className="card-tag">MERN</span>
        </div>
        <div className="card-body">
          <div className="card-description">
            Designed an Social Media Platform Like Instagram,Users Can Post Pictures,Comment ,Chat with their friends and Edit their Profile
          </div>
          <div className="feature-grid">
            <div className="feature-item">
              ...
              <span className="feature-text">MongoDB</span>
            </div>
            <div className="feature-item">
              <div className="feature-icon">
                <svg viewBox="0 0 24 24">
              ...
              <span className="feature-text">Express JS</span>
            </div>
            <div className="feature-item">
              <div className="feature-icon">
                <svg viewBox="0 0 24 24">
              ...
              <span className="feature-text">Node JS</span>
            </div>
            <div className="feature-item">
              <div className="feature-icon">
                <svg viewBox="0 0 24 24">
              ...
              <span className="feature-text">React JS</span>
            </div>
          </div>
          <div className="card-actions">
            <button className="card-button" onClick={() => window.open("https://convosphere-xczk.onrender.com/", "_blank")}>View Project</button>
          </div>
        </div>
