      ...
      <div className="card">
        ...
        <div className="card-body">
          <div className="card-description">
            Designed an EMS Admin can add tasks and assign them to the Employee. Employee can accept and update the status of the task
          ...
          <div className="card-actions">
            ...
            <button className="card-button" onClick={() => window.open("https://p-ems-sudhanshutiwari-cs-projects.vercel.app", "_blank")}>View Project</button>
          </div>
        </div>
