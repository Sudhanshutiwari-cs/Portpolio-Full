  ...
  return (
    ...
    >
      ...
      <div className="px-3 pt-2 text-black font-semibold text-sm">
        “Your instant gateway to real-time weather updates anywhere, anytime.”
        <br />
        <GitButton linkTo="https://github.com/Sudhanshutiwari-cs/weatherapp" />
      </div>
      <div className="flex flex-col">
        ...
        />
        <div className="flex flex-wrap justify-evenly items-center m-2 rounded-md border-2 border-black p-2 bg-white shadow-[3px_3px_0_0_black]">
          <img
            src="/images/html.svg"
            alt="React"
