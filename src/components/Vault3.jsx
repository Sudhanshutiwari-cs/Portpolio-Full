    ...
    <StyledWrapper>
      <div className="card">
        ...
        <div className="card-title-area">
          <span>SkySnap</span>
          <span className="card-tag">API Project</span>
        </div>
        <div className="card-body">
          <div className="card-description">
            Designed A Real time Weather application to get updates about weather and Fetched Weather Conditions using OpenWeather API
          ...
          <div className="feature-grid">
            <div className="feature-item">
              ...
              <span className="feature-text">HTML</span>
            </div>
            <div className="feature-item">
              <div className="feature-icon">
                <svg viewBox="0 0 24 24">
              ...
              <span className="feature-text">CSS</span>
            </div>
            <div className="feature-item">
              <div className="feature-icon">
                <svg viewBox="0 0 24 24">
              ...
              <span className="feature-text">Javascript</span>
            </div>
            <div className="feature-item">
              <div className="feature-icon">
                <svg viewBox="0 0 24 24">
              ...
              <span className="feature-text">API</span>
            </div>
          </div>
          <div className="card-actions">
            <button className="card-button" onClick={() => window.open("https://sudhanshutiwari-cs.github.io/weatherapp/")}>View Project</button>
          </div>
        </div>
